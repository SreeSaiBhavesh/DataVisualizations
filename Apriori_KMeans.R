data = read.csv("/home/matlab/Market_Basket_Optimisation.csv", header=FALSE)
...
dataset = read.transactions(file = "/home/matlab/Market_Basket_Optimisation.csv", sep = ",",rm.duplicates = T)
